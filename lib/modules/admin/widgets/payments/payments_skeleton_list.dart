...
class PaymentsSkeletonList extends StatelessWidget {
  final int count;

  const PaymentsSkeletonList({super.key, this.count = 4});
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              _SkeletonBox(width: 100.w, height: 12.h, color: base),
              const Spacer(),
              _SkeletonBox(width: 80.w, height: 12.h, color: base),
            ],
          ),
          SizedBox(height: 12.h),
          Row(
            children: [
              Expanded(
                child: _SkeletonBox(height: 36.h, radius: 16.r, color: base),
              ),
              SizedBox(width: 10.w),
              Expanded(
                child: _SkeletonBox(height: 36.h, radius: 16.r, color: base),
